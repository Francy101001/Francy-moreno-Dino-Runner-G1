...
HAT=[pygame.image.load(os.path.join(IMG_DIR, "Dino/Hat.png"))]
...
RAT = [
    pygame.image.load(os.path.join(IMG_DIR, "Bird/raton1.png")),
...
STAIRS = pygame.image.load(os.path.join(IMG_DIR, "Bird/escalera.png"))

CLOUD = pygame.image.load(os.path.join(IMG_DIR, 'Other/Cloud.png'))
SHIELD = pygame.image.load(os.path.join(IMG_DIR, 'Other/shield.png'))
HAMMER = pygame.image.load(os.path.join(IMG_DIR, 'Other/hammer.png'))
VITAMIN = pygame.image.load(os.path.join(IMG_DIR, 'Other/vitamina.png'))
